...
class Pworking extends StatefulWidget {
  static final routeName = 'PtWorking';
  var id;
  Pworking(this.id);
  @override
  _PworkingState createState() => _PworkingState();
}

class _PworkingState extends State<Pworking> {
  @override
