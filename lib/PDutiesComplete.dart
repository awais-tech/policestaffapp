...
class PDutiesComplete extends StatefulWidget {
  static final routeName = 'PDutiesComplete';
  var id;
  PDutiesComplete(this.id);

  @override
  _PDutiesCompleteState createState() => _PDutiesCompleteState();
}

class _PDutiesCompleteState extends State<PDutiesComplete> {
  @override
