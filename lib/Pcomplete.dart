...
class Pcomplete extends StatefulWidget {
  static final routeName = 'Pcomplete';
  var id;
  Pcomplete(this.id);
  @override
  _PcompleteState createState() => _PcompleteState();
}

class _PcompleteState extends State<Pcomplete> {
  @override
  Widget build(BuildContext context) {
    final streams = FirebaseFirestore.instance
        .collection('Complaints')
        .where('status', isEqualTo: 'Complete')
        .where('PoliceOfficerid', isEqualTo: widget.id)
        .snapshots();
    return Scaffold(
